...
import static com.jd.login.v12.write.Header.getHeader;

public class Function14A {
    public static void main(String[] args) {
        try {
            ...
            File file3 = new File("/Users/admin/Documents/K/login/1206/1206_device_a.hashmap1");
            ...
            FileWriter fileWriter = new FileWriter("/Users/admin/Documents/K/login/1206/1206_feature_a.csv",true);
            ...
            for (Map.Entry<Integer, ArrayList<TradeAndLogin>> map : hashMapHashMap.entrySet()) {
                ...
                for (TradeAndLogin map2 : tradeAndLoginArrayList) {
                    ...
                    // 3_30天内交易段数
                    ArrayList<TradeAndLogin> range3_30Trade = getRangeTrade(tradeAndLoginArrayList, thisIntervalTrade, 3, 30);
                    stringBuffer.append(getRangeIntervalTradeNum(range3_30Trade)).append(",");
                    // 3_30天登录与交易的平均时间间隔
                    stringBuffer.append(getRangeIntervalTradeLoginTimeDiffAvg(range3_30Trade)).append(",");
                    // 3_30天内交易平均间隔天数
                    stringBuffer.append(getRangeIntervalTradeDayDiffAvg(range3_30Trade)).append(",");
                    // 3_30天登录与交易的最大时间间隔
                    stringBuffer.append(getRangeIntervalTradeLoginTimeDiffMax(range3_30Trade)).append(",");
                    // 3_30天内交易最大间隔天数
                    stringBuffer.append(getRangeIntervalTradeDayDiffMax(range3_30Trade)).append(",");
                    // 3_30天登录与交易的最小时间间隔
                    stringBuffer.append(getRangeIntervalTradeLoginTimeDiffMin(range3_30Trade)).append(",");
                    // 3_30天内交易最小间隔天数
                    stringBuffer.append(getRangeIntervalTradeDayDiffMin(range3_30Trade)).append(",");
                    // 3_30天内交易时间0-3点次数
                    stringBuffer.append(getRangeIntervalTradeTimeRangeNum(range3_30Trade, 0, 3)).append(",");
                    // 3_30天内交易时间4-10点次数
                    stringBuffer.append(getRangeIntervalTradeTimeRangeNum(range3_30Trade, 4, 10)).append(",");
                    // 3_30天内交易时间11-12点次数
                    stringBuffer.append(getRangeIntervalTradeTimeRangeNum(range3_30Trade, 11, 12)).append(",");
                    // 3_30天内交易时间13-17点次数
                    stringBuffer.append(getRangeIntervalTradeTimeRangeNum(range3_30Trade, 13, 17)).append(",");
                    // 3_30天内交易时间18-20点次数
                    stringBuffer.append(getRangeIntervalTradeTimeRangeNum(range3_30Trade, 18, 20)).append(",");
                    // 3_30天内交易时间21-23点次数
                    stringBuffer.append(getRangeIntervalTradeTimeRangeNum(range3_30Trade, 21, 23)).append(",");
                    // 3_30天内交易时间0-3点占比
                    stringBuffer.append(getPercent(range3_30Trade.size(),getRangeIntervalTradeTimeRangeNum(range3_30Trade, 0, 3))).append(",");
                    // 3_30天内交易时间4-10点占比
                    stringBuffer.append(getPercent(range3_30Trade.size(),getRangeIntervalTradeTimeRangeNum(range3_30Trade, 4, 10))).append(",");
                    // 3_30天内交易时间11-12点占比
                    stringBuffer.append(getPercent(range3_30Trade.size(),getRangeIntervalTradeTimeRangeNum(range3_30Trade, 11, 12))).append(",");
                    // 3_30天内交易时间13-17点占比
                    stringBuffer.append(getPercent(range3_30Trade.size(),getRangeIntervalTradeTimeRangeNum(range3_30Trade, 13, 17))).append(",");
                    // 3_30天内交易时间18-20点占比
                    stringBuffer.append(getPercent(range3_30Trade.size(),getRangeIntervalTradeTimeRangeNum(range3_30Trade, 18, 20))).append(",");
                    // 3_30天内交易时间21-23点占比
                    stringBuffer.append(getPercent(range3_30Trade.size(),getRangeIntervalTradeTimeRangeNum(range3_30Trade, 21, 23))).append(",");
                    // 3_30天内交易为周一
                    stringBuffer.append(getRangeIntervalTradeDayOfWeek(range3_30Trade, 0)).append(",");
                    // 3_30天内交易为周二
                    stringBuffer.append(getRangeIntervalTradeDayOfWeek(range3_30Trade, 1)).append(",");
                    // 3_30天内交易为周三
                    stringBuffer.append(getRangeIntervalTradeDayOfWeek(range3_30Trade, 2)).append(",");
                    // 3_30天内交易为周四
                    stringBuffer.append(getRangeIntervalTradeDayOfWeek(range3_30Trade, 3)).append(",");
                    // 3_30天内交易为周五
                    stringBuffer.append(getRangeIntervalTradeDayOfWeek(range3_30Trade, 4)).append(",");
                    // 3_30天内交易为周六
                    stringBuffer.append(getRangeIntervalTradeDayOfWeek(range3_30Trade, 5)).append(",");
                    // 3_30天内交易为周日
                    stringBuffer.append(getRangeIntervalTradeDayOfWeek(range3_30Trade, 6)).append(",");
                    // 3_30天内交易是否为节假日
                    stringBuffer.append(getRangeIntervalTradeIsFestival(range3_30Trade)).append(",");
                    // 3_30天内交易是否为节假日前一天
                    stringBuffer.append(getRangeIntervalTradeIsFestivalBefore1Day(range3_30Trade)).append(",");
                    // 30_60天内交易段数
                    ...
                    // 上上上段交易登录与交易的时间间隔
                    boolean hasLast3Trade = getHasLastXTrade(tradeAndLoginArrayList, thisIntervalTrade, 3);
                    ArrayList<Data> last3Trade = getLastXTrade(tradeAndLoginArrayList, thisIntervalTrade, 3);
                    Data last3TradeLogin = getLastXTradeLogin(tradeAndLoginArrayList, thisIntervalTrade, 3);
                    if (hasLast3Trade) {
                        stringBuffer.append(getTradeLoginTimeDiff(last3Trade, last3TradeLogin)).append(",");
                    } else {
                        stringBuffer.append("-1").append(",");
                    }
                    // 上上上段交易内交易时间0-3点
                    if (hasLast3Trade) {
                        stringBuffer.append(getTradeTimeRangeNum(last3Trade, 0, 3)).append(",");
                    } else {
                        stringBuffer.append("-1").append(",");
                    }
                    // 上上上段交易内交易时间4-10点
                    if (hasLast3Trade) {
                        stringBuffer.append(getTradeTimeRangeNum(last3Trade, 4, 10)).append(",");
                    } else {
                        stringBuffer.append("-1").append(",");
                    }
                    // 上上上段交易内交易时间11-12点
                    if (hasLast3Trade) {
                        stringBuffer.append(getTradeTimeRangeNum(last3Trade, 11, 12)).append(",");
                    } else {
                        stringBuffer.append("-1").append(",");
                    }
                    // 上上上段交易内交易时间13-17点
                    if (hasLast3Trade) {
                        stringBuffer.append(getTradeTimeRangeNum(last3Trade, 13, 17)).append(",");
                    } else {
                        stringBuffer.append("-1").append(",");
                    }
                    // 上上上段交易内交易时间18-20点
                    if (hasLast3Trade) {
                        stringBuffer.append(getTradeTimeRangeNum(last3Trade, 18, 20)).append(",");
                    } else {
                        stringBuffer.append("-1").append(",");
                    }
                    // 上上上段交易内交易时间21-23点
                    if (hasLast3Trade) {
                        stringBuffer.append(getTradeTimeRangeNum(last3Trade, 21, 23)).append(",");
                    } else {
                        stringBuffer.append("-1").append(",");
                    }
                    // 上上上段交易内交易为周一
                    if (hasLast3Trade) {
                        stringBuffer.append(getTradeDayOfWeek(last3Trade, 0)).append(",");
                    } else {
                        stringBuffer.append("-1").append(",");
                    }
                    // 上上上段交易内交易为周二
                    if (hasLast3Trade) {
                        stringBuffer.append(getTradeDayOfWeek(last3Trade, 1)).append(",");
                    } else {
                        stringBuffer.append("-1").append(",");
                    }
                    // 上上上段交易内交易为周三
                    if (hasLast3Trade) {
                        stringBuffer.append(getTradeDayOfWeek(last3Trade, 2)).append(",");
                    } else {
                        stringBuffer.append("-1").append(",");
                    }
                    // 上上上段交易内交易为周四
                    if (hasLast3Trade) {
                        stringBuffer.append(getTradeDayOfWeek(last3Trade, 3)).append(",");
                    } else {
                        stringBuffer.append("-1").append(",");
                    }
                    // 上上上段交易内交易为周五
                    if (hasLast3Trade) {
                        stringBuffer.append(getTradeDayOfWeek(last3Trade, 4)).append(",");
                    } else {
                        stringBuffer.append("-1").append(",");
                    }
                    // 上上上段交易内交易为周六
                    if (hasLast3Trade) {
                        stringBuffer.append(getTradeDayOfWeek(last3Trade, 5)).append(",");
                    } else {
                        stringBuffer.append("-1").append(",");
                    }
                    // 上上上段交易内交易为周日
                    if (hasLast3Trade) {
                        stringBuffer.append(getTradeDayOfWeek(last3Trade, 6)).append(",");
                    } else {
                        stringBuffer.append("-1").append(",");
                    }
                    // 上上上段交易内交易是否为节假日
                    if (hasLast3Trade) {
                        stringBuffer.append(getTradeIsFestival(last3Trade)).append(",");
                    } else {
                        stringBuffer.append("-1").append(",");
                    }
                    // 上上上段交易内交易是否为节假日前一天
                    if (hasLast3Trade) {
                        stringBuffer.append(getTradeIsFestivalBefore1Day(last3Trade)).append(",");
                    } else {
                        stringBuffer.append("-1").append(",");
                    }
                    // 历史交易登录与交易的平均时间间隔
                    ...
                    // 上上段登录设备30min内连接IP次数
                    if (hasLast2Trade) {
                        stringBuffer.append(getDeviceConnectIPTimeNum(last3TradeLogin, allLoginArrayList, 30)).append(",");
                    } else {
                        stringBuffer.append(-1).append(",");
                    }
                    // 上上段登录设备60min内连接IP次数
